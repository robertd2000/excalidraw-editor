...
export function Navbar() {
    ...
    return (
        <div
            className={`flex justify-between p-3 ${theme === 'dark' ? 'bg-indigo-700 text-white' : 'bg-indigo-300'} items-center`}>
            ...
            <div className='flex justify-between gap-4'>
                <label className='inline-flex items-center cursor-pointer'>
                    ...
                    />
                    <div
                        className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 dark:peer-checked:bg-blue-600"></div>
            ...
            Switch to Dark Theme
                ...
                <div className='flex justify-between gap-2'>
                    <button
                        className={`border-1 border-black p-1 rounded-md cursor-pointer ${theme === 'dark' ? 'bg-zinc-900' : 'bg-white'}`}
